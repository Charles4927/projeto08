...
# import django.db.backends.pyodbc
...
#             'odbc_connect': 'DRIVER={MySQL ODBC 8.0 Unicode Driver}; SERVER=%s; PORT=%s; DATABASE=%s; UID=%s; PWD=%s' %
#             ('177.47.167.82', '3306', 'cdtmes', 'admin', 'Admin@Condutec')
#         },
#     }
# }
